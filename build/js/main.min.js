...
/* harmony import */ var _modules_main_animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/main-animation */ "./js/modules/main-animation.js");
/* harmony import */ var _modules_main_animation__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_main_animation__WEBPACK_IMPORTED_MODULE_4__);
...
var introInfo = document.querySelector('.intro__info-wrapper');
var header = document.querySelector('.header');
var breakpoint = window.matchMedia('(min-width:1024px)');

var onEnterPress = function onEnterPress(modal, evt) {
  if (evt.key === 'Enter') {
    evt.preventDefault();
    closeLoader(modal);
...
var closeLoader = function closeLoader(modal) {
